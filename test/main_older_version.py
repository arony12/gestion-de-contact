...
# ------------------- Interface graphique -------------------
app = tb.Window(themename="flatly")  # Thèmes: "superhero", "cyborg", "flatly", "darkly", etc.
app.title("Contacteo")
...
ttk.Button(frame_bottom, text="📧 connecté Gmail", command=importer_gmail_ui).pack(side="right", padx=5)
